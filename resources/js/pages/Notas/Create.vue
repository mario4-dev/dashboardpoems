...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: 'Crear', href: route('notas.create') },
];
    ...
    <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
      <div class="min-h-[100vh] flex-1 rounded-xl border border-sidebar-border/70 dark:border-sidebar-border p-6">
        <div class="max-w-2xl mx-auto">
          <h1 class="text-2xl font-semibold mb-6">Crear Nota</h1>
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="flex items-center justify-between">
              <Link :href="route('notas.index')" class="px-4 py-2 text-sm border rounded-md">Cancelar</Link>
